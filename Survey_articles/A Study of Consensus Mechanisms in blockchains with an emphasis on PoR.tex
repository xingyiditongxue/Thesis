...
\paragraph{} The data layer defines the representation of data within a blockchain system. %这里的断句
...
The data layer represents the distributed ledger, which is shared by all the nodes within the decentralized blockchian system. It encapsulates the underlying data block, %这种地方不需要用then
 the related data structure and algorithms of data encryption and time stamping, etc.
\paragraph{} 
Through the presence of data layer, every distributed node can % could尽量不要用,就用Present式
